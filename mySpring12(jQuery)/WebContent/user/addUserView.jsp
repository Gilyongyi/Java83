...
$(function(){
	...
	$($("#add")).bind('click',function(){
		...
		if($('option[value="phone2"]').val() != "" && $('option[value="phone2"]').val() != "") {
			$('option[value="phone"]').val($('option[value="phone2"]').val() + "-" + $('option[value="phone2"]').val() + "-" + $('option[value="phone3"]').val()) 
		} else {
			$('option[value="phone"]').val("");
		}
		
		$('form').attr("method","POST");
		$('form').attr("action","/user/addUser").submit();
	})
		...
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td id="add" background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						가입
					</td>
					...
					<td id="reset" background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						취소
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
