...
<script type="text/javascript">
	...
	$(function(){
		...
		$("input[name='userId']").bind("keydown",function(){
			if(event.keyCode == '13') {
				fncCheckDuplication();
			}
		})
		$("td[id='duple']").click(function(){
			if($("input[name='userId']").val()!=null && $("input[name='userId']").val().length >0){
				$('form').attr("action","/user/checkDuplication").submit();
			}else{
		...
		$('td[id="use"]').click(function(){
			if(opener) {
				$(opener.document).find("input[name='userId']").val($("input[name='userId']").val());
			}
			window.close();
		})
		
		$('td[id="close"]').click(function(){
			window.close();
		})
	})
					...
					<td>
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td id="duple" align="center" background="/images/ct_btng02.gif" class="ct_btn" style="padding-top:3px;">
									중복확인
								</td>
								<td width="4" height="21">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<c:if test="${ ! empty result && result }">
						...
						<td id="use" background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
							사용
						</td>
					...
					<td id="close" background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						닫기
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
