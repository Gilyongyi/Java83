...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		<td colspan="11" >전체 ${pageVO.totalCount} 건수, 현재 ${pageVO.currentPage} 페이지  <a href="/listProduct.do?menu=search&order=asc">◀낮은가격순▶</a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
		...
		<td align="center">
		   ...
		   <input type="hidden" id="order" name="order" value="${searchVO.order}"/>
