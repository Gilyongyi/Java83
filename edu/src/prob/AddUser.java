...
public class AddUser extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		out.println("<p><p><a href='/edu/prob/findUser.html' name=내정보보기><input type=button value='내정보보기'</a>");
		out.println("<p><p><a href='/edu/prob/addUser.html' name=뒤로><input type=button value='뒤로'</a>");
