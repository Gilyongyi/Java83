...
<tr>
	...
	<td colspan="3"> <input type=radio name=gender value=male>남자
			 <input type=radio name=gender value=female>여자</td>
</tr>
<tr>
	<td  bgcolor=#D5D5D5>* 생년월일</td>
	<td><input type=text size=7 name=birth>년
	<select name=birth>
	<option>선택<option value=1>1<option value=2>2
	...
	<td colspan="2"><input type=radio name=solar value=solar>양력
			<input type=radio name=solar value=lunar>음력
			<input type=radio name=solar value=leap>윤달</td>
<tr>
	<td  bgcolor=#D5D5D5>* 최종학력</td>
	<td colspan="3"><select name=academic>
	<option>선택하세요
	<option value=high>고등학교
	<option value=univ>대학교
	</select></td>
</tr>
<tr>
...
<tr>
	...
	<td><input type=radio name=marital value=single>미혼
			<input type=radio name=marital value=married>기혼
	</td>
	<td  bgcolor=#D5D5D5>&nbsp;자녀수&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td><select name=children><option>선택
	<option value=0>0<option value=1>1<option value=2>2</select>명</td>
</tr>
<tr>
	<td rowspan="3"  bgcolor=#D5D5D5>* 연락처</td>
	<td>·전화번호 <input type=text size=4 name=phone>-<input type=text size=4 name=phone>-
	<input type=text size=4 name=phone></td>
	<td colspan="2"><input type=radio name=wherenum value=house>집
