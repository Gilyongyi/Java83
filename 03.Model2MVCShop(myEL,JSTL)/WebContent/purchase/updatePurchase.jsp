...
<%PurchaseVO purVO = (PurchaseVO)request.getAttribute("PurchaseVO"); %>
...
<form name="updatePurchase" method="post"	action="/updatePurchase.do?tranNo=${pur.tranNo }">
